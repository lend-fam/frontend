...
export interface AnalyticsContextType {
	...
	trackTransaction: (type: 'supply' | 'withdraw' | 'borrow' | 'repay', token: string, amount: string, success: boolean) => void;
	trackTransactionStart: (type: 'supply' | 'withdraw' | 'borrow' | 'repay', token: string, amount: string) => void;
	trackTransactionComplete: (type: 'supply' | 'withdraw' | 'borrow' | 'repay', token: string, amount: string, transactionHash: string) => void;
	trackTransactionError: (type: 'supply' | 'withdraw' | 'borrow' | 'repay', token: string, amount: string, error: string) => void;
