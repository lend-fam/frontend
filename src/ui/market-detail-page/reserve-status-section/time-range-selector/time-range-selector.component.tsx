...
export const TimeRangeSelector: FC<TimeRangeSelectorProps> = typedMemo(
	({ selectedRange, onRangeChange, cTokenMarket }) => {
					...
					return (
						<button
							...
							style={{
								...
								borderRadius: '4px',
								backgroundColor:
									selectedRange === range.value ? '#3b82f6' : isDisabled ? '#f9fafb' : '#ffffff',
