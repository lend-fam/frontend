...
import css from './collection-deposit-modal.module.css';

export interface CollectionDepositModalProps {
	isOpen: boolean;
	onClose: () => void;
...
const CollectionDepositModalComponent: FC<CollectionDepositModalProps> = ({
	isOpen,
	onClose,
	vaultAddress,
	collectionData,
	...
	const getMaxBalance = useCallback(() => {
		return balanceData.walletBalance || 0n;
	...
	const getBalanceInfo = () => {
		return {
			...
			value: balanceData.walletBalance
				? MarketService.formatTokenBalance(balanceData.walletBalance, tokenDecimals)
				: '0',
		};
	};
				...
				<FlexContainer variant="column" className={styles.section}>
					...
					<div className={styles.overviewContainer}>
						<div className={styles.overviewRow}>
							<span className={styles.overviewLabel}>You will deposit</span>
							<span className={styles.overviewValue}>
								{amount || '0'} {cleanSymbol}
							</span>
						</div>
						<div className={styles.overviewRow}>
							<span className={styles.overviewLabel}>You will receive</span>
							<span className={styles.overviewValue}>≈ {amount || '0'} Vault Shares</span>
						</div>
						{vaultTokenData && (
							<div className={styles.overviewRow}>
								<span className={styles.overviewLabel}>APY</span>
...
export const CollectionDepositModal = typedMemo(CollectionDepositModalComponent);
