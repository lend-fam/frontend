...
export type CTokenMarket = {
	...
	exchangeRate: Scalars['BigInt']['output'];
	gapPerBlock: Scalars['BigInt']['output'];
	id: Scalars['ID']['output'];
	interestRateModelAddress: Scalars['Bytes']['output'];
	interestRateModelType: Scalars['String']['output'];
	jugAddress?: Maybe<Scalars['Bytes']['output']>;
	jumpMultiplierPerBlock: Scalars['BigInt']['output'];
	kink: Scalars['BigInt']['output'];
	multiplierPerBlock: Scalars['BigInt']['output'];
	name: Scalars['String']['output'];
	potAddress?: Maybe<Scalars['Bytes']['output']>;
...
export type GetSimpleApyStatsQuery = {
	__typename?: 'Query';
	ctokenAPYDatas: Array<{
		__typename?: 'CTokenAPYData';
		id: number;
		timestamp: number;
		cTokenMarket: string;
...
export type GetAllApyStatsQuery = {
	__typename?: 'Query';
	ctokenAPYDatas: Array<{
		__typename?: 'CTokenAPYData';
		id: number;
...
export type GetCTokenMarketsQuery = {
	__typename?: 'Query';
	ctokenMarkets: Array<{
		__typename?: 'CTokenMarket';
		id: string;
...
export type GetMarketOverviewQuery = {
	...
	ctokenMarket?: {
		...
		jugAddress?: string | null;
		createdAtTimestamp: string;
		updatedAtTimestamp: string;
	} | null;
};

export type GetDataRangeQueryVariables = Exact<{
	cTokenMarket: Scalars['String']['input'];
}>;

export type GetDataRangeQuery = {
	__typename?: 'Query';
...
export type GetCTokenApyDataDebugQuery = {
	__typename?: 'Query';
	ctokenAPYDatas: Array<{
		__typename?: 'CTokenAPYData';
		id: number;
 ...
 * });
 */
export function useGetSimpleApyStatsQuery(
	baseOptions: ApolloReactHooks.QueryHookOptions<GetSimpleApyStatsQuery, GetSimpleApyStatsQueryVariables> &
		({ variables: GetSimpleApyStatsQueryVariables; skip?: boolean } | { skip: boolean }),
) {
	const options = { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useQuery<GetSimpleApyStatsQuery, GetSimpleApyStatsQueryVariables>(
		GetSimpleApyStatsDocument,
		options,
	);
}
export function useGetSimpleApyStatsLazyQuery(
	baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetSimpleApyStatsQuery, GetSimpleApyStatsQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useLazyQuery<GetSimpleApyStatsQuery, GetSimpleApyStatsQueryVariables>(
		GetSimpleApyStatsDocument,
		options,
	);
}
export function useGetSimpleApyStatsSuspenseQuery(
	baseOptions?:
		| ApolloReactHooks.SkipToken
		| ApolloReactHooks.SuspenseQueryHookOptions<GetSimpleApyStatsQuery, GetSimpleApyStatsQueryVariables>,
) {
	const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useSuspenseQuery<GetSimpleApyStatsQuery, GetSimpleApyStatsQueryVariables>(
		GetSimpleApyStatsDocument,
		options,
	);
}
...
export type GetSimpleApyStatsQueryResult = ApolloReactCommon.QueryResult<
	GetSimpleApyStatsQuery,
	GetSimpleApyStatsQueryVariables
>;
 ...
 * });
 */
export function useGetAllApyStatsQuery(
	baseOptions?: ApolloReactHooks.QueryHookOptions<GetAllApyStatsQuery, GetAllApyStatsQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useQuery<GetAllApyStatsQuery, GetAllApyStatsQueryVariables>(
		GetAllApyStatsDocument,
		options,
	);
}
export function useGetAllApyStatsLazyQuery(
	baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetAllApyStatsQuery, GetAllApyStatsQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useLazyQuery<GetAllApyStatsQuery, GetAllApyStatsQueryVariables>(
		GetAllApyStatsDocument,
		options,
	);
}
export function useGetAllApyStatsSuspenseQuery(
	baseOptions?:
		| ApolloReactHooks.SkipToken
		| ApolloReactHooks.SuspenseQueryHookOptions<GetAllApyStatsQuery, GetAllApyStatsQueryVariables>,
) {
	const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useSuspenseQuery<GetAllApyStatsQuery, GetAllApyStatsQueryVariables>(
		GetAllApyStatsDocument,
		options,
	);
}
...
export type GetAllApyStatsQueryResult = ApolloReactCommon.QueryResult<
	GetAllApyStatsQuery,
	GetAllApyStatsQueryVariables
>;
 ...
 * });
 */
export function useGetCTokenMarketsQuery(
	baseOptions?: ApolloReactHooks.QueryHookOptions<GetCTokenMarketsQuery, GetCTokenMarketsQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useQuery<GetCTokenMarketsQuery, GetCTokenMarketsQueryVariables>(
		GetCTokenMarketsDocument,
		options,
	);
}
export function useGetCTokenMarketsLazyQuery(
	baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetCTokenMarketsQuery, GetCTokenMarketsQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useLazyQuery<GetCTokenMarketsQuery, GetCTokenMarketsQueryVariables>(
		GetCTokenMarketsDocument,
		options,
	);
}
export function useGetCTokenMarketsSuspenseQuery(
	baseOptions?:
		| ApolloReactHooks.SkipToken
		| ApolloReactHooks.SuspenseQueryHookOptions<GetCTokenMarketsQuery, GetCTokenMarketsQueryVariables>,
) {
	const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useSuspenseQuery<GetCTokenMarketsQuery, GetCTokenMarketsQueryVariables>(
		GetCTokenMarketsDocument,
		options,
	);
}
...
export type GetCTokenMarketsQueryResult = ApolloReactCommon.QueryResult<
	GetCTokenMarketsQuery,
	GetCTokenMarketsQueryVariables
>;
...
>;
export const GetDataRangeDocument = gql`
...
/**
 * __useGetDataRangeQuery__
 *
 * To run a query within a React component, call `useGetDataRangeQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetDataRangeQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetDataRangeQuery({
 *   variables: {
 *      cTokenMarket: // value for 'cTokenMarket'
 *   },
 * });
 */
export function useGetDataRangeQuery(
	baseOptions: ApolloReactHooks.QueryHookOptions<GetDataRangeQuery, GetDataRangeQueryVariables> &
		({ variables: GetDataRangeQueryVariables; skip?: boolean } | { skip: boolean }),
) {
	const options = { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useQuery<GetDataRangeQuery, GetDataRangeQueryVariables>(GetDataRangeDocument, options);
}
export function useGetDataRangeLazyQuery(
	baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetDataRangeQuery, GetDataRangeQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useLazyQuery<GetDataRangeQuery, GetDataRangeQueryVariables>(GetDataRangeDocument, options);
}
export function useGetDataRangeSuspenseQuery(
	baseOptions?:
		| ApolloReactHooks.SkipToken
		| ApolloReactHooks.SuspenseQueryHookOptions<GetDataRangeQuery, GetDataRangeQueryVariables>,
) {
	const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useSuspenseQuery<GetDataRangeQuery, GetDataRangeQueryVariables>(
		GetDataRangeDocument,
		options,
	);
}
export type GetDataRangeQueryHookResult = ReturnType<typeof useGetDataRangeQuery>;
export type GetDataRangeLazyQueryHookResult = ReturnType<typeof useGetDataRangeLazyQuery>;
export type GetDataRangeSuspenseQueryHookResult = ReturnType<typeof useGetDataRangeSuspenseQuery>;
export type GetDataRangeQueryResult = ApolloReactCommon.QueryResult<GetDataRangeQuery, GetDataRangeQueryVariables>;
 ...
 * });
 */
export function useGetCTokenApyDataDebugQuery(
	baseOptions: ApolloReactHooks.QueryHookOptions<GetCTokenApyDataDebugQuery, GetCTokenApyDataDebugQueryVariables> &
		({ variables: GetCTokenApyDataDebugQueryVariables; skip?: boolean } | { skip: boolean }),
) {
	const options = { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useQuery<GetCTokenApyDataDebugQuery, GetCTokenApyDataDebugQueryVariables>(
		GetCTokenApyDataDebugDocument,
		options,
	);
}
export function useGetCTokenApyDataDebugLazyQuery(
	baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
		GetCTokenApyDataDebugQuery,
		GetCTokenApyDataDebugQueryVariables
	>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useLazyQuery<GetCTokenApyDataDebugQuery, GetCTokenApyDataDebugQueryVariables>(
		GetCTokenApyDataDebugDocument,
		options,
	);
}
export function useGetCTokenApyDataDebugSuspenseQuery(
	baseOptions?:
		| ApolloReactHooks.SkipToken
		| ApolloReactHooks.SuspenseQueryHookOptions<GetCTokenApyDataDebugQuery, GetCTokenApyDataDebugQueryVariables>,
) {
	const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useSuspenseQuery<GetCTokenApyDataDebugQuery, GetCTokenApyDataDebugQueryVariables>(
		GetCTokenApyDataDebugDocument,
		options,
	);
}
...
export type GetCTokenApyDataDebugQueryResult = ApolloReactCommon.QueryResult<
	GetCTokenApyDataDebugQuery,
	GetCTokenApyDataDebugQueryVariables
>;
