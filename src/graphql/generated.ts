...
export type GetHistoricalApyQuery = { __typename?: 'Query', ctokenAPYDatas: Array<{ __typename?: 'CTokenAPYData', id: number, timestamp: number, cTokenMarket: string, interval: string, supplyAPY: string, borrowAPY: string, utilizationRate: string, totalSupply: string, totalBorrows: string, exchangeRate: string, blockNumber: string, transactionHash: string, baseRatePerBlock: string, multiplierPerBlock: string, jumpMultiplierPerBlock: string, kink: string }> };
...
export type GetLatestApyStatsQuery = { __typename?: 'Query', ctokenAPYDatas: Array<{ __typename?: 'CTokenAPYData', id: number, timestamp: number, cTokenMarket: string, interval: string, supplyAPY: string, borrowAPY: string, utilizationRate: string, totalSupply: string, totalBorrows: string, exchangeRate: string, blockNumber: string, transactionHash: string, baseRatePerBlock: string, multiplierPerBlock: string, jumpMultiplierPerBlock: string, kink: string }> };
...
export type GetMarketOverviewQuery = { __typename?: 'Query', ctokenMarket?: { __typename?: 'CTokenMarket', id: string, symbol: string, name: string, decimals: number, totalSupply: string, totalBorrows: string, totalReserves: string, cash: string, exchangeRate: string, borrowIndex: string, collateralFactor: string, reserveFactor: string, interestRateModelAddress: string, interestRateModelType: string, baseRatePerBlock: string, multiplierPerBlock: string, jumpMultiplierPerBlock: string, kink: string, gapPerBlock: string, potAddress?: string | null, jugAddress?: string | null, createdAtTimestamp: string, updatedAtTimestamp: string } | null };
...
export type GetDataRangeQuery = { __typename?: 'Query', earliest: Array<{ __typename?: 'CTokenAPYData', timestamp: number }>, latest: Array<{ __typename?: 'CTokenAPYData', timestamp: number }> };
 ...
 * });
 */
export function useGetDataRangeQuery(baseOptions: ApolloReactHooks.QueryHookOptions<GetDataRangeQuery, GetDataRangeQueryVariables> & ({ variables: GetDataRangeQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetDataRangeQuery, GetDataRangeQueryVariables>(GetDataRangeDocument, options);
      }
export function useGetDataRangeLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetDataRangeQuery, GetDataRangeQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetDataRangeQuery, GetDataRangeQueryVariables>(GetDataRangeDocument, options);
        }
export function useGetDataRangeSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetDataRangeQuery, GetDataRangeQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetDataRangeQuery, GetDataRangeQueryVariables>(GetDataRangeDocument, options);
        }
