 ...
 * });
 */
export function useTestSubgraphQuery(
	baseOptions?: ApolloReactHooks.QueryHookOptions<TestSubgraphQuery, TestSubgraphQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useQuery<TestSubgraphQuery, TestSubgraphQueryVariables>(TestSubgraphDocument, options);
}
export function useTestSubgraphLazyQuery(
	baseOptions?: ApolloReactHooks.LazyQueryHookOptions<TestSubgraphQuery, TestSubgraphQueryVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useLazyQuery<TestSubgraphQuery, TestSubgraphQueryVariables>(TestSubgraphDocument, options);
}
export function useTestSubgraphSuspenseQuery(
	baseOptions?:
		| ApolloReactHooks.SkipToken
		| ApolloReactHooks.SuspenseQueryHookOptions<TestSubgraphQuery, TestSubgraphQueryVariables>,
) {
	const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : { ...defaultOptions, ...baseOptions };
	return ApolloReactHooks.useSuspenseQuery<TestSubgraphQuery, TestSubgraphQueryVariables>(
		TestSubgraphDocument,
		options,
	);
}
